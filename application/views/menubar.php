<?php if (count($this->staff->data) > 0): ?>
<?php if ($this->staff->privilege & (1+2+4+8)): ?>
<ul class="nav">
...
<?php endif ?>
<!--
<?php if ($this->staff->privilege & (16+32+64+128)): ?>
<ul class="nav">
